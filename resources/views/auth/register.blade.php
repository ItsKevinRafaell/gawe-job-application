    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div>
            ...
            <select name="role" id="role_id" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                ...
                <option value="project_freelancer" {{ old('role') == 'project_freelancer' ? 'selected' : '' }}>Freelancer</option>
                <option value="project_client" {{ old('role') == 'project_client' ? 'selected' : '' }}>Client</option>
            </select>
